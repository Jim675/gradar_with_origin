...
struct GReflectionInfo
{
	...
	GReflectionInfo(const QString &className, GCreateInstanceFunc ptr)
	{
...
public:
	...
	{
		auto it = mpReflectionMap->find(className);
	...
	static void initGReflectionInfo(GReflectionInfo<T> *pInfo)
	{
